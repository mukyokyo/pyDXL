...
if __name__ == "__main__":
  ...
  def func1(dx):
    ...
    try:
      ...
      print(f'Ping(2)=', dx.Ping(2, echo = ec))
      print(f'Ping(3)=', dx.Ping(3, echo = ec))
      print(f'Ping(4)=', dx.Ping(4, echo = ec))
      print(f'Ping(5)=', dx.Ping(5, echo = ec))
